...
let PERMISSIONING_CONTRACT_ABI = [
    "function updatePermissions(address from, address to, uint8 action)", 
...
const checkAndUpdatePermissions = async (account, allPermissions) => {
    ...
    if (!hasRequiredPermissions) {
        return updatePermissions(account.address, allPermissions);
    }*/
...
const updatePermissions = async (accAddr, allPermissions) => {
