...
export class DigitalArtsDetailsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.digitalArtsSub = this.digitalArtsService.digitalArts$.subscribe(newList => {
      this.art = newList[this.nftId];
    });
  }
  ...
  ngOnDestroy() {
    ...
    if (this.digitalArtsSub) {
      this.digitalArtsSub.unsubscribe();
    }
  }
