...
| eth_getBlockByHash | Returns the block hash.| | With block hash of invalid length, this api respond with error {"code":-32603,"message":"nibble missing in string"}. With non-hexadecimal characters provided in block hash, the api respond with error {"code":-32603,"message":"non-hex character"}.
| eth_getBlockByNumber | Returns the block number.|
| eth_getBlockTransactionCountByHash | Returns the number of block transactions by block matching the given block.| | With hash of invalid length, this api respond with error {"code":-32603,"message":"nibble missing in string"}. With non-hexadecimal characters provided in hash, the api respond with error {"code":-32603,"message":"non-hex character"}.
...
| eth_getCode | Returns code at a given address.| | With address of invalid length, this api respond with error {"code":-32603,"message":"nibble missing in string"}. With non-hexadecimal characters provided in address, the api respond with error {"code":-32603,"message":"non-hex character"}.
| eth_getLogs | Returns an array of all logs matching a given filter object.| "pending" treated the same as "latest". Supports single address as a filter parameter and not an array. | | If response of this api contains more than 3k blocks the we get error {"code":-32603,"data":"block range in the given request is not supported, max block range supported is 3000 blocks","message":"Server error"}.
...
| eth_getTransactionReceipt | Returns the receipt of a transaction by transaction hash.| | With hash of invalid length, this api respond with error {"code":-32603,"message":"nibble missing in string"}. With non-hexadecimal characters provided in hash, the api respond with error {"code":-32603,"message":"non-hex character"}.
| eth_getTransactionCount | Returns the number of transactions sent from an address. | "pending" treated the same as "latest". | With address of invalid length, this api respond with error {"code":-32603,"message":"nibble missing in string"}. With non-hexadecimal characters provided in address, the api respond with error {"code":-32603,"message":"non-hex character"}.
...
| eth_newFilter | Creates a filter object, based on filter options, to notify when the state changes (logs). To check if the state has changed, call eth_getFilterChanges. Filters are not saved in persistent storage - if a node restarts, the filters will be lost. | Supports single address as a filter parameter and not an array. | Once maximum filter limit has been reached(which is 1000) we get error: {"code":-32603,"data":"Maximum Number of Active Filter Limit reached","message":"Server error: Maximum Number of Active Filter Limit reached"}
| eth_newBlockFilter	| Creates a filter in the node, to notify when a new block arrives. To check if the state has changed, call eth_getFilterChanges. Filters are not saved in persistent storage - if a node restarts, the filters will be lost.| | Once maximum filter limit has been reached(which is 1000) we get error:{"code":-32603,"data":"Maximum Number of Active Filter Limit reached","message":"Server error: Maximum Number of Active Filter Limit reached"}.
...
| eth_getFilterChanges | Polling method for a filter, which returns an array of logs which occurred since last poll. | "pending" treated the same as "latest". | With invalid filter_id if we execute this api we get {"code":-32602,"data":"filter not found","message":"Invalid Parameters: filter not found"}
| eth_getFilterLogs | Returns an array of all logs matching filter with given id. | "pending" treated the same as "latest". | If response of this api contains more than 3k blocks the we get error {"code":-32603,"data":"block range in the given request is not supported, max block range supported is 3000 blocks","message":"Server error"}. With invalid filter_id if we execute this api we get {"code":-32602,"data":"filter not found","message":"Invalid Parameters: filter not found"}
