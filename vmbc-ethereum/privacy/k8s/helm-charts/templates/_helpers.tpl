...
{{- define "user-dapp.image" -}}
{{ include "common.images.image" (dict "imageRoot" .Values.userDApp.image "global" .Values.global) }}
{{- end -}}

{{- define "admin-dapp.image" -}}
{{ include "common.images.image" (dict "imageRoot" .Values.adminDApp.image "global" .Values.global) }}
{{- end -}}

{{- define "privacy-service.image" -}}
{{ include "common.images.image" (dict "imageRoot" .Values.privacyService.image "global" .Values.global) }}
{{- end -}}
